 ...
 * (widget 72406ce58900366af2861a4ccab).
 *
...
// TrustIndex company id. This is the FRENCH profile: the German site's own
// review widget loads it (widget 72406ce58900366af2861a4ccab), and its Google
// feature ID is French too, so the schema tracks what visitors actually see.
...
const PLACE_NAME = 'Hercules Merchandising France';
const MAPS_URL = 'https://www.google.com/maps/place/Hercules+Merchandising+France/@30.886403,-49.4022061,3z/data=!3m1!4b1!4m8!3m7!1s0x21d159209e369b9d:0xa126617f91835893!8m2!3d30.886403!4d-49.4022062!9m1!1b1!16s%2Fg%2F11vkhhwqmm?entry=ttu&g_ep=EgoyMDI2MDIxOC4wIKXMDSoASAFQAw%3D%3D';
...
async function fetchTrustIndexRating() {
  ...
  const response = await fetch(TRUSTINDEX_FEED, {
    headers: { 'User-Agent': 'hercules-merchandise.de build script' }
  });
